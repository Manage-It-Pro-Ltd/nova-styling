!(function(e) {
	...
	function(e, t, n) {
		(e.exports = n(6)(!1)).push([
			e.i,
			".dark-mode-toggle[data-v-1fda6f16]{position:fixed;bottom:0;right:0;width:50px;height:50px;background:#7C3AED;border-radius:.6rem 0 0;padding:1rem .6rem .6rem .8rem}.nova-dark-theme .dark-mode-toggle[data-v-1fda6f16]{background:#7C3AED}.dark-mode-toggle[data-v-1fda6f16]:hover{background-color:#F87171}.dark-mode-toggle[data-v-1fda6f16]:focus{outline:none}.nova-dark-theme .dark-mode-toggle[data-v-1fda6f16]:hover{background:#F87171}.dark-mode-active[data-v-1fda6f16]{margin-bottom:-2px;color:#ffffff}.dark-mode-disabled[data-v-1fda6f16]{margin-bottom:-2px;-webkit-transform:rotate(180deg);transform:rotate(180deg);color:rgb(255 255 255)}",
			"",
		]);
	},
	function(e, t) {
